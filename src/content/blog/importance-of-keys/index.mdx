...
Let's briefly understand how React works to set up some context on component rendering.

  <img 
    src="https://cdn.hashnode.com/res/hashnode/image/upload/v1685870876169/d8dbf02d-f627-4d50-8d69-e16860f730cf.gif" 
    alt="React reconciliation process" 
...
<iframe
  src="https://codesandbox.io/embed/upbeat-star-s9cqcn?fontsize=14&hidenavigation=1&theme=dark&view=preview"
  style={{
    width: "100%",
    height: "500px",
    border: 0,
...
Now let's add fruit in each box incrementally as you go down a list (refer to image below). Follow the same drill for all lists.
  ...
  <img 
    src="https://cdn.hashnode.com/res/hashnode/image/upload/v1686854490921/99b23abe-b11f-4c4b-8463-48249f88302d.png" 
    alt="Adding fruits incrementally" 
...
1. Case 1: Remove a fruit box from below (pear)
  ...
  <img 
    src="https://cdn.hashnode.com/res/hashnode/image/upload/v1686854525545/e97ea88c-ff37-4a54-96c9-bb9075309f3f.png" 
    alt="Removing fruit from bottom" 
    style="width: 100%; height: auto;" 
  />
...
2. Case 2: Remove a fruit box from above (apple)
  ...
  <img 
    src="https://cdn.hashnode.com/res/hashnode/image/upload/v1686855131989/64da55df-d64c-4f06-b7e9-94a7e04baed9.png" 
    alt="Removing fruit from top" 
    style="width: 100%; height: auto;" 
  />
...
By default, React uses order within the parent to differenciate between components.
  ...
  <img 
    src="https://cdn.hashnode.com/res/hashnode/image/upload/v1686856501051/59e3a5cb-0466-4b73-a8a7-a4524e8ce1fa.png" 
    alt="No key behavior diagram" 
    style="width: 100%; height: auto;" 
  />
...
* Passing the index as the key value which is unique still does not yield the expected behavior ?! 🤔
  ...
  <img 
    src="https://cdn.hashnode.com/res/hashnode/image/upload/v1686860096431/d874cc3e-8329-4f0d-aae8-06f98a46e778.png" 
    alt="Index as key behavior diagram" 
    style="width: 100%; height: auto;" 
  />
...
* Passing the key as a unique identifier which is also consistent throughout re-renders yields expected results!! 😃
  ...
  <img 
    src="https://cdn.hashnode.com/res/hashnode/image/upload/v1686859607028/45a3e3ac-4d5d-4d47-847f-531fe6557a18.png" 
    alt="Item.id as key behavior diagram" 
    style="width: 100%; height: auto;" 
  />
...
For React a <mark>new key implies a new component</mark> thus unmounting the current component and mounting a new one with the initial state (0)
  ...
  <img 
    src="https://cdn.hashnode.com/res/hashnode/image/upload/v1686859946633/65506296-1cfc-43f8-842c-efc2998addab.png" 
    alt="Generated key behavior diagram" 
    style="width: 100%; height: auto;" 
  />
...
<iframe
  src="https://codesandbox.io/embed/eloquent-goldstine-lmrv8h?fontsize=14&hidenavigation=1&theme=dark"
  style={{
    width: "100%",
    height: "500px",
    border: 0,
  ...
  title="Keys Beyond Rendering Demo"
  allow="accelerometer; ambient-light-sensor; camera; encrypted-media; geolocation; gyroscope; hid; microphone; midi; payment; usb; vr; xr-spatial-tracking"
  sandbox="allow-forms allow-modals allow-popups allow-presentation allow-same-origin allow-scripts"
/>
