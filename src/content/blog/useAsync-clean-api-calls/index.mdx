...
<iframe
  src="https://codesandbox.io/embed/data-fetching-without-async-8mzorp?fontsize=14&hidenavigation=1&theme=dark"
  style={{
    width: "100%",
    height: "500px",
    border: 0,
  ...
  title="Data Fetching Without useAsync"
...
<iframe
  src="https://codesandbox.io/embed/data-fetching-with-async-35h6x4?fontsize=14&hidenavigation=1&theme=dark"
  style={{
    width: "100%",
    height: "500px",
    border: 0,
  ...
  title="Data Fetching With useAsync"
  allow="accelerometer; ambient-light-sensor; camera; encrypted-media; geolocation; gyroscope; hid; microphone; midi; payment; usb; vr; xr-spatial-tracking"
  sandbox="allow-forms allow-modals allow-popups allow-presentation allow-same-origin allow-scripts"
/>
